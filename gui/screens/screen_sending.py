...
def _translate_smtp_error(msg: str) -> str:
    ...
    _map = [
        ...
        ("SmtpClientAuthentication is disabled", "SMTP AUTH отключён — включите в Outlook: Настройки → Почта → SMTP"),
        ("5.7.139", "Microsoft: SMTP AUTH отключён (5.7.139) — включите на outlook.com/mail/options/"),
        ("5.7.138", "Microsoft: SMTP AUTH отключён (5.7.138) — нужен OAuth2 или включить SMTP в настройках"),
