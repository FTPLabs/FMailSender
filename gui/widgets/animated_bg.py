"""
  ...
  _COLORS = [
      QColor(139, 92, 246),   # #8B5CF6 violet
      QColor(124, 58, 237),   # #7C3AED deep violet
      QColor(6, 182, 212),    # #06B6D4 cyan
      QColor(167, 139, 250),  # #A78BFA light violet
      QColor(91, 33, 182),    # #5B21B6 dark violet
      QColor(8, 145, 178),    # #0891B2 dark cyan
      QColor(196, 181, 253),  # #C4B5FD pale violet
  ]
  ...
  class AnimatedBackground(QWidget):
      ...
      PARTICLE_COUNT = 60
      CONNECTION_DIST_RATIO = 0.17  # fraction of min(w, h)
      FPS = 30
      ...
      def paintEvent(self, _event):
          ...
          for p, px, py in pts:
              ...
              if gr > 1:
                  ...
                  t_out = QColor(glow_c); t_out.setAlpha(0)
              ...
              if ir > 1:
                  ...
                  t_in = QColor(inner_c); t_in.setAlpha(0)
