  ...
  return (
    <div className="page max-w-4xl">
      ...
      <div className="card space-y-3">
        ...
        {preview && htmlMode && cfg.body_html && (
          <div className="border border-[#3a3a66]/40 rounded-lg overflow-hidden">
            <div className="bg-[#1c1c35] px-3 py-1.5 text-xs text-[#6666aa] border-b border-[#3a3a66]/30">
              Превью HTML — {'{{name}}'} → Иван
            </div>
            <iframe className="w-full bg-white" style={{ height: '280px' }}
