...
const RU: Dictionary = {
  ...
  'layout.navigation': 'Навигация', 'layout.coreStatus': 'Статус ядра', 'layout.tour': 'Экскурсия', 'layout.accounts': 'аккаунты', 'layout.recipients': 'получатели', 'layout.theme': 'режим темы', 'layout.language': 'язык', 'layout.light': 'Светлая тема', 'layout.dark': 'Тёмная тема', 'layout.system': 'Как в системе',
...
const EN: Dictionary = {
  ...
  'layout.navigation': 'Navigation', 'layout.coreStatus': 'Core status', 'layout.tour': 'App tour', 'layout.accounts': 'accounts', 'layout.recipients': 'recipients', 'layout.theme': 'theme mode', 'layout.language': 'language', 'layout.light': 'Light theme', 'layout.dark': 'Dark theme', 'layout.system': 'Follow system',
