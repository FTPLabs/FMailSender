"""
  ...
  def check_license() -> Tuple[bool, Optional[LicenseInfo], str]:
      ...
      # Проверка HMAC seal — защита от ручной правки license.dat
      ...
      try:
          ...
          # Обновляем время последней онлайн-проверки
          ...
          # Оффлайн-режим: проверяем grace period
          ...
          if hours_offline <= OFFLINE_GRACE_HOURS:
              ...
              # Создаём LicenseInfo из сохранённых данных
              saved_payload = {
